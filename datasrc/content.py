...
image_generator_shield = Image("generator_shield", "generator_shield.png")
...
container.images.Add(image_generator_shield)
...
container.spritesets.Add(set_generator_shield)
...
container.sprites.Add(Sprite("generator_shield", set_generator_shield, 0,0,1,1))
...
# sword grips
for i in range(0, 3):
	container.sprites.Add(Sprite("weapon_part1_"+str(5+i), set_weapons, 18, 26+i*2, 3, 2))
...
# sword grip bgs
for i in range(0, 3):
	container.sprites.Add(Sprite("weapon_part1_bg_"+str(5+i), set_weapons, 21, 26+i*2, 3, 2))
...
# sword blades
for i in range(0, 3):
	container.sprites.Add(Sprite("weapon_part2_"+str(6+i), set_weapons, 24, 26+i*2, 8, 2))

container.sprites.Add(Sprite("weapon_part2_9", set_weapons, 24, 22, 8, 4))
container.sprites.Add(Sprite("weapon_part2_10", set_weapons, 24, 18, 8, 4))
...
container.sprites.Add(Sprite("kit_generator", set_buildings, 6, 5, 2, 2))
...
container.sprites.Add(Sprite("generator", set_buildings, 		9,4,3,4))
container.sprites.Add(Sprite("generator_color", set_buildings, 	13,0,3,4))
