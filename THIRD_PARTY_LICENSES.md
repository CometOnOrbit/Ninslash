...
Copyright © 2007–2014 Magnus Auvinen. The zlib-style terms are reproduced in
`license.txt`.

## json-parser

Copyright © 2012–2013 James McLaughlin and contributors. BSD 2-Clause terms
are reproduced in `src/engine/external/json-parser/LICENSE.txt`.
