...
-- Performance optimization: increased optimization level and specific flags
release_settings.cc.flags:Add("-O3")
release_settings.cc.flags:Add("-march=native")
release_settings.cc.flags:Add("-ffast-math")
release_settings.cc.flags:Add("-funroll-loops")
release_settings.cc.flags:Add("-flto")
release_settings.link.flags:Add("-flto")
