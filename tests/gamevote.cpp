...
int main()
{
	...
	assert(LocalGameModeVoteCategory(LOCAL_MODE_TDM) == GAMEVOTE_CATEGORY_TEAM);
	assert(LocalGameModeVoteCategory(LOCAL_MODE_CTF) == GAMEVOTE_CATEGORY_TEAM);
	assert(LocalGameModeVoteCategory(LOCAL_MODE_INSTAGIB_CTF) == GAMEVOTE_CATEGORY_TEAM);
	assert(LocalGameModeVoteCategory(LOCAL_MODE_REACTOR_ASSAULT) == GAMEVOTE_CATEGORY_TEAM);
	assert(LocalGameModeVoteCategory(LOCAL_MODE_BALL) == GAMEVOTE_CATEGORY_TEAM);
	assert(LocalGameModeVoteCategory(LOCAL_MODE_DM) == GAMEVOTE_CATEGORY_SOLO);
	assert(LocalGameModeVoteCategory(LOCAL_MODE_GRENADE_DM) == GAMEVOTE_CATEGORY_SOLO);
	assert(LocalGameModeVoteCategory(LOCAL_MODE_BATTLE_ROYALE) == GAMEVOTE_CATEGORY_SOLO);
