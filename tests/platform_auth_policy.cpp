...
int main()
{
	...
	assert(PlatformJoinDecision(PLATFORM_IDENTITY_ANONYMOUS, 0, false, PLATFORM_AUTH_UNAVAILABLE) ==
		   PLATFORM_JOIN_ANONYMOUS);
	assert(PlatformJoinDecision(PLATFORM_IDENTITY_ANONYMOUS, 1, false, PLATFORM_AUTH_UNAVAILABLE) ==
		   PLATFORM_JOIN_ANONYMOUS);
	assert(PlatformJoinDecision(PLATFORM_IDENTITY_ANONYMOUS, 2, false, PLATFORM_AUTH_UNAVAILABLE) ==
		   PLATFORM_JOIN_REJECT);
	assert(PlatformJoinDecision(PLATFORM_IDENTITY_ANONYMOUS, 1, true, PLATFORM_AUTH_UNAVAILABLE) ==
		   PLATFORM_JOIN_REJECT);
	...
	assert(PlatformJoinDecision(PLATFORM_IDENTITY_STEAM, 1, false, PLATFORM_AUTH_INVALID_TICKET) ==
		   PLATFORM_JOIN_REJECT);
	assert(PlatformJoinDecision(PLATFORM_IDENTITY_STEAM, 1, false, PLATFORM_AUTH_REPLAYED_TICKET) ==
		   PLATFORM_JOIN_REJECT);
