...
int main()
{
	const char *pGood = "{\"schema_version\":1,\"content_type\":\"mod\",\"published_file_id\":\"42\",\"name\":\"Safe\",\"description\":\"Test content\",\"version\":\"1\",\"author\":\"A\",\"target_protocol\":\"test\",\"content_hash\":\"0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef\",\"content_rating\":\"everyone\",\"api_version\":1,\"capabilities\":[\"resources\",\"client_theme\"],\"dependencies\":[{\"schema_version\":1,\"content_type\":\"mod\",\"published_file_id\":\"7\",\"version\":\"2\",\"content_hash\":\"abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789\"}],\"maps\":[\"maps/a.map\"],\"scripts\":[\"rules/main.lua\"]}";
	char aError[128];
	...
	const char *pMap = "{\"schema_version\":1,\"content_type\":\"map\",\"published_file_id\":\"44\",\"name\":\"Map\",\"description\":\"A map\",\"version\":\"1\",\"author\":\"A\",\"target_protocol\":\"test\",\"content_hash\":\"0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef\",\"content_rating\":\"everyone\",\"maps\":[\"maps/main.map\"],\"resources\":[]}";
	assert(ContentManifestParse(pMap, (int)strlen(pMap), "test", &Manifest, aError, sizeof(aError)) && Manifest.m_ContentType == CONTENT_TYPE_MAP);
	...
	const char *pMissingRating = "{\"schema_version\":1,\"content_type\":\"mod\",\"published_file_id\":\"42\",\"name\":\"Safe\",\"description\":\"Test content\",\"version\":\"1\",\"author\":\"A\",\"target_protocol\":\"test\",\"content_hash\":\"0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef\",\"api_version\":1,\"capabilities\":[],\"maps\":[],\"resources\":[],\"scripts\":[]}";
	assert(!ContentManifestValidateText(pMissingRating, (int)strlen(pMissingRating), "test", aError, sizeof(aError)));
	const char *pInvalidRating = "{\"schema_version\":1,\"content_type\":\"mod\",\"published_file_id\":\"42\",\"name\":\"Safe\",\"description\":\"Test content\",\"version\":\"1\",\"author\":\"A\",\"target_protocol\":\"test\",\"content_hash\":\"0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef\",\"content_rating\":\"unrated\",\"api_version\":1,\"capabilities\":[],\"maps\":[],\"resources\":[],\"scripts\":[]}";
	assert(!ContentManifestValidateText(pInvalidRating, (int)strlen(pInvalidRating), "test", aError, sizeof(aError)));
	assert(!ContentManifestValidateText("{\"schema_version\":1,\"content_type\":\"mod\",\"published_file_id\":\"x\"}", 25, "test", aError, sizeof(aError)));
