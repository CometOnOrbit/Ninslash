...
if use_bundle:
	...
	# create Ninslash appfolder
	clientbundle_content_dir = os.path.join(package_dir, "Ninslash.app/Contents")
	...
	os.mkdir(os.path.join(package_dir, "Ninslash.app"))
	...
	shutil.copy("other/icons/Ninslash.icns", clientbundle_resource_dir)
...
<dict>
	...
	# create Ninslash Server appfolder
	serverbundle_content_dir = os.path.join(package_dir, "Ninslash Server.app/Contents")
	...
	os.mkdir(os.path.join(package_dir, "Ninslash Server.app"))
	...
	shutil.copy("other/icons/Ninslash_srv.icns", serverbundle_resource_dir)
...
<dict>
        ...
        <string>English</string>
        <key>CFBundleExecutable</key>
        <string>ninslash_server</string>
        <key>CFBundleIconFile</key>
        <string>Ninslash_srv</string>
        <key>CFBundleInfoDictionaryVersion</key>
        <string>6.0</string>
        <key>CFBundlePackageType</key>
        <string>APPL</string>
...
if use_dmg:
	...
	os.system("hdiutil create -srcfolder %s -volname Ninslash -quiet %s_temp" % (package_dir, package))
