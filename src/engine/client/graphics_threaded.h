...
class CCommandBuffer
{
  ...
  public:
	...
	struct SCommand_CreateTextureBuffer : public SCommand
	{
		SCommand_CreateTextureBuffer() : SCommand(CMD_CREATETEXTUREBUFFER) {}
	...
	void *AllocData(unsigned WantedSize) { return m_DataBuffer.Alloc(WantedSize); }
...
class CGraphics_Threaded : public IEngineGraphics
{
  ...
  public:
	...
	virtual void BlendBuffer();
	virtual void BlendLight();
	...
	virtual void TrianglesBegin();
	virtual void TrianglesEnd();
