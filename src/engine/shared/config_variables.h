...
MACRO_CONFIG_INT(
	PlayerCountry, player_country, -1, -1, 1000, CFGFLAG_SAVE | CFGFLAG_CLIENT | CFGFLAG_CLOUD, "Country of the player")
MACRO_CONFIG_STR(Password, password, 32, "", CFGFLAG_CLIENT | CFGFLAG_SERVER, "Password to the server")
MACRO_CONFIG_STR(
	Logfile, logfile, 128, "", CFGFLAG_SAVE | CFGFLAG_CLIENT | CFGFLAG_SERVER, "Filename to log all output to")
MACRO_CONFIG_INT(ConsoleOutputLevel,
...
MACRO_CONFIG_INT(
	ClLoadCountryFlags, cl_load_country_flags, 1, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Load and show country flags")

MACRO_CONFIG_INT(
	ClAutoDemoRecord, cl_auto_demo_record, 0, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Automatically record demos")
MACRO_CONFIG_INT(ClAutoDemoMax,
				 cl_auto_demo_max,
				 10,
				 0,
				 1000,
...
MACRO_CONFIG_INT(ClAutoScreenshot,
				 cl_auto_screenshot,
				 0,
				 0,
				 1,
...
MACRO_CONFIG_INT(ClAutoScreenshotMax,
...
MACRO_CONFIG_INT(BrFilterEmpty,
				 br_filter_empty,
				 0,
				 0,
				 1,
...
MACRO_CONFIG_INT(BrFilterSpectators,
...
MACRO_CONFIG_INT(
	BrFilterFriends, br_filter_friends, 0, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Filter out servers with no friends")
MACRO_CONFIG_INT(BrFilterCountry,
				 br_filter_country,
				 0,
				 0,
				 1,
...
MACRO_CONFIG_INT(BrFilterCountryIndex,
...
MACRO_CONFIG_INT(BrFilterPing,
				 br_filter_ping,
				 999,
				 0,
				 999,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT | CFGFLAG_CLOUD,
				 "Ping to filter by in the server browser")
MACRO_CONFIG_STR(BrFilterGametype,
				 br_filter_gametype,
				 128,
				 "",
				 CFGFLAG_SAVE | CFGFLAG_CLIENT | CFGFLAG_CLOUD,
...
MACRO_CONFIG_INT(
	BrFilterGametypeStrict, br_filter_gametype_strict, 0, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Strict gametype filter")
MACRO_CONFIG_STR(
	BrFilterServerAddress, br_filter_serveraddress, 128, "", CFGFLAG_SAVE | CFGFLAG_CLIENT, "Server address to filter")
MACRO_CONFIG_INT(
	BrFilterPure, br_filter_pure, 0, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Filter out non-standard servers in browser")
MACRO_CONFIG_INT(BrFilterPureMap,
				 br_filter_pure_map,
				 0,
				 0,
				 1,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Filter out non-standard maps in browser")
MACRO_CONFIG_INT(BrFilterCompatversion,
				 br_filter_compatversion,
				 1,
				 0,
				 1,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Filter out non-compatible servers in browser")
...
MACRO_CONFIG_INT(BrMaxRequests,
				 br_max_requests,
				 25,
				 0,
				 1000,
...
MACRO_CONFIG_INT(
	SndMusic, snd_enable_music, 0, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT | CFGFLAG_CLOUD, "Play background music")
...
MACRO_CONFIG_INT(
	GoreWallSplatter, gore_wallsplatter, 1, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT | CFGFLAG_CLOUD, "Wall splatter enable")
...
MACRO_CONFIG_INT(GfxBorderless,
				 gfx_borderless,
				 0,
				 0,
				 1,
...
MACRO_CONFIG_INT(
	GfxAlphabits, gfx_alphabits, 0, 0, 0, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Alpha bits for framebuffer (fullscreen only)")
...
MACRO_CONFIG_INT(
	GfxTextureCompression, gfx_texture_compression, 0, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Use texture compression")
...
MACRO_CONFIG_INT(
	GfxAsyncRender, gfx_asyncrender, 0, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Do rendering async from the the update")
...
MACRO_CONFIG_STR(Bindaddr,
				 bindaddr,
				 128,
				 "",
				 CFGFLAG_CLIENT | CFGFLAG_SERVER | CFGFLAG_MASTER,
...
MACRO_CONFIG_INT(SvHighBandwidth,
				 sv_high_bandwidth,
				 0,
				 0,
				 1,
...
MACRO_CONFIG_INT(SvRconBantime,
				 sv_rcon_bantime,
				 5,
				 0,
				 1440,
...
MACRO_CONFIG_INT(SvAutoDemoMax,
				 sv_auto_demo_max,
				 10,
				 0,
				 1000,
...
MACRO_CONFIG_INT(EcAuthTimeout,
				 ec_auth_timeout,
				 30,
				 1,
				 120,
...
MACRO_CONFIG_INT(
	EcOutputLevel, ec_output_level, 1, 0, 2, CFGFLAG_ECON, "Adjusts the amount of information in the external console")
...
MACRO_CONFIG_INT(SvMapGenSeed, sv_mapgen_seed, 0, 0, 0x7FFFFFFF, CFGFLAG_SERVER, "Map generation seed")
MACRO_CONFIG_INT(SvMapGenRandSeed, sv_mapgen_random_seed, 1, 0, 1, CFGFLAG_SERVER, "Random map generation seed")
MACRO_CONFIG_INT(SvRoamCheckpoints,
				 sv_roam_checkpoints,
				 24,
				 3,
				 63,
				 CFGFLAG_SERVER,
				 "Number of checkpoints in a generated Roam race")
...
MACRO_CONFIG_INT(SvPveContractVoteTime,
				 sv_pve_contract_vote_time,
				 8,
				 3,
				 60,
				 CFGFLAG_SERVER,
				 "Seconds allowed for a team contract vote")

// Client-owned permanent PvE progress. Current-run combat state is never stored here.
MACRO_CONFIG_INT(ClPveProgressVersion,
				 cl_pve_progress_version,
				 2,
				 0,
				 999,
...
MACRO_CONFIG_STR(ClPveResearchMask,
				 ...
				 CFGFLAG_CLIENT | CFGFLAG_CLOUD,
				 "Legacy PvE research mask; migrated to pve_progress.json")
MACRO_CONFIG_INT(ClPveHighestInvasion,
				 cl_pve_highest_invasion,
				 0,
				 0,
				 9999,
				 CFGFLAG_CLIENT | CFGFLAG_CLOUD,
				 "Legacy highest Invasion floor; migrated to pve_progress.json")
MACRO_CONFIG_INT(ClPvePreferredCheckpoint,
				 cl_pve_preferred_checkpoint,
				 1,
				 1,
				 9999,
				 CFGFLAG_CLIENT | CFGFLAG_CLOUD,
				 "Legacy preferred Invasion checkpoint; migrated to pve_progress.json")
MACRO_CONFIG_INT(ClPveDroneTutorialSeen,
				 cl_pve_drone_tutorial_seen,
				 0,
				 0,
				 1,
				 CFGFLAG_CLIENT | CFGFLAG_CLOUD,
				 "Legacy drone tutorial state; migrated to pve_progress.json")

// One-click local game hosting. The password is intentionally session-only.
MACRO_CONFIG_INT(ClLocalServerMode,
...
MACRO_CONFIG_INT(ClRoomVisibility,
				 ...
				 3,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Room visibility: solo, friends, LAN, or public")
MACRO_CONFIG_INT(ClLocalServerMap,
				 cl_local_server_map,
				 0,
				 0,
				 7,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT | CFGFLAG_CLOUD,
				 "Selected local game map preset")
MACRO_CONFIG_STR(ClLocalServerWorkshopMap,
				 cl_local_server_workshop_map,
				 256,
				 "",
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Validated workshop:<id>:<entry> map locator selected by a room preset")
MACRO_CONFIG_INT(ClLocalServerDifficulty,
				 cl_local_server_difficulty,
				 1,
				 1,
				 50,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT | CFGFLAG_CLOUD,
				 "Local game map or AI difficulty")
MACRO_CONFIG_INT(ClLocalServerInvasionStart,
				 cl_local_server_invasion_start,
				 0,
				 0,
				 2,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Invasion start policy: team checkpoint, floor one, or custom floor")
MACRO_CONFIG_INT(ClLocalServerInvasionFloor,
				 cl_local_server_invasion_floor,
				 1,
				 1,
				 9999,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Custom local Invasion starting floor")
MACRO_CONFIG_INT(ClLocalServerBots,
				 cl_local_server_bots,
				 5,
				 0,
				 16,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT | CFGFLAG_CLOUD,
				 ...
				 "0 disables bots")
MACRO_CONFIG_INT(ClLocalServerMaxClients,
				 cl_local_server_max_clients,
				 8,
				 1,
				 16,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT | CFGFLAG_CLOUD,
				 "Maximum total player slots in a local game")
MACRO_CONFIG_INT(ClLocalServerPort,
				 cl_local_server_port,
				 8303,
				 1024,
				 65535,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Port used by the local game server")
MACRO_CONFIG_INT(ClLocalServerLan,
				 cl_local_server_lan,
				 0,
				 0,
				 1,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Allow other players on the LAN to join the local game")
MACRO_CONFIG_STR(
	ClLocalServerName, cl_local_server_name, 64, "Local Game", CFGFLAG_SAVE | CFGFLAG_CLIENT, "Local game server name")
MACRO_CONFIG_STR(
	ClLocalServerPassword, cl_local_server_password, 32, "", CFGFLAG_CLIENT, "Session-only local game password")
MACRO_CONFIG_INT(ClLocalServerRandomSeed,
				 cl_local_server_random_seed,
				 1,
				 0,
				 1,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT | CFGFLAG_CLOUD,
				 "Generate a new local game map seed on every launch")
MACRO_CONFIG_INT(ClLocalServerSeed,
				 cl_local_server_seed,
				 0,
				 0,
				 0x7FFFFFFF,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT | CFGFLAG_CLOUD,
				 "Fixed local game map seed")
MACRO_CONFIG_INT(ClLocalServerRoguelite,
				 cl_local_server_roguelite,
				 1,
				 0,
				 1,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT | CFGFLAG_CLOUD,
				 "Enable the PvE Roguelite Director in local games")
MACRO_CONFIG_INT(ClLocalServerContracts,
				 cl_local_server_contracts,
				 1,
				 0,
				 1,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT | CFGFLAG_CLOUD,
...
MACRO_CONFIG_INT(ClLocalServerHordeWaves,
				 ...
				 100,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Horde target wave count, or zero for endless")
MACRO_CONFIG_INT(ClLocalServerExtractionTime,
				 cl_local_server_extraction_time,
				 4,
				 2,
				 15,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Extraction mission time limit in minutes")
MACRO_CONFIG_INT(ClLocalServerRoamCheckpoints,
				 cl_local_server_roam_checkpoints,
				 24,
				 3,
				 63,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT | CFGFLAG_CLOUD,
				 "Number of checkpoints in a local Roam race")
MACRO_CONFIG_INT(ClLocalServerDmScore,
				 cl_local_server_dm_score,
				 20,
				 1,
				 1000,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Deathmatch score limit")
MACRO_CONFIG_INT(ClLocalServerTdmScore,
				 cl_local_server_tdm_score,
				 50,
				 1,
				 1000,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Team deathmatch score limit")
MACRO_CONFIG_INT(ClLocalServerCtfScore,
				 cl_local_server_ctf_score,
				 500,
				 1,
				 1000,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Capture the flag score limit")
MACRO_CONFIG_INT(ClLocalServerReactorScore,
				 cl_local_server_reactor_score,
				 400,
				 1,
				 1000,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Reactor Assault score limit")
MACRO_CONFIG_INT(
	ClLocalServerBallScore, cl_local_server_ball_score, 5, 1, 100, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Ball goal limit")
MACRO_CONFIG_INT(ClLocalServerAdvanced,
				 cl_local_server_advanced,
				 0,
				 0,
				 1,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Show advanced local game rules")

// ===== AntiPing / Prediction System =====
MACRO_CONFIG_INT(
	ClAntiPing, cl_antiping, 0, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Enable antiping, more aggressive prediction")
MACRO_CONFIG_INT(ClAntiPingPlayers,
				 cl_antiping_players,
				 1,
				 0,
				 1,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Predict other player's movement more aggressively (only if cl_antiping is 1)")
MACRO_CONFIG_INT(ClAntiPingGrenade,
				 cl_antiping_grenade,
				 1,
				 0,
				 1,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Predict grenades (only if cl_antiping is 1)")
MACRO_CONFIG_INT(ClAntiPingWeapons,
				 cl_antiping_weapons,
				 1,
				 0,
				 1,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Predict weapon projectiles (only if cl_antiping is 1)")
MACRO_CONFIG_INT(ClAntiPingSmooth,
				 cl_antiping_smooth,
				 0,
				 0,
				 1,
...
MACRO_CONFIG_INT(ClAntiPingGunfire,
				 cl_antiping_gunfire,
				 1,
				 0,
				 1,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Predict gunfire and show predicted weapon physics")
...
MACRO_CONFIG_INT(
	ClShowpred, cl_showpred, 0, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Show ingame prediction time in milliseconds")

// ===== HUD Modularity =====
MACRO_CONFIG_INT(ClShowhudHealthAmmo,
...
MACRO_CONFIG_INT(ClShowhudSpectatorCount,
				 ...
				 1,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Show ingame HUD (Spectator Count)")
MACRO_CONFIG_INT(ClShowhudPlayerPosition,
...
MACRO_CONFIG_INT(ClShowhudPlayerSpeed,
...
MACRO_CONFIG_INT(ClShowhudPlayerAngle,
...
MACRO_CONFIG_INT(ClPveObjectiveDisplay,
				 ...
				 2,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT | CFGFLAG_CLOUD,
				 "PvE objective display: 0 scoreboard, 1 always, 2 updates")

// ===== Chat Filtering =====
MACRO_CONFIG_INT(ClShowChat,
				 cl_showchat,
				 1,
				 0,
				 2,
...
MACRO_CONFIG_INT(ClShowChatTeamMembersOnly,
...
MACRO_CONFIG_INT(
	ClShowChatSystem, cl_show_chat_system, 1, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Show chat messages from the server")
MACRO_CONFIG_INT(ClShowKillMessages, cl_showkillmessages, 1, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Show kill messages")
MACRO_CONFIG_INT(
	ClShowsocial, cl_showsocial, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show social data like names, clans, chat")
MACRO_CONFIG_INT(ClFilterchat,
				 cl_filterchat,
				 0,
				 0,
				 2,
...
MACRO_CONFIG_INT(
	ClHideSelfScore, cl_hide_self_score, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Hide player's score in scoreboard")
MACRO_CONFIG_INT(
	ClScoreboardUserId, cl_scoreboard_userid, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show client IDs in scoreboard")
MACRO_CONFIG_INT(
	ClDisableWhisper, cl_disable_whisper, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Disable whisper feature")

// ===== Nameplate Customization =====
MACRO_CONFIG_INT(
	ClNamePlatesClan, cl_nameplates_clan, 0, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Show clan names in name plates")
MACRO_CONFIG_INT(ClNamePlatesClanSize,
				 cl_nameplates_clan_size,
				 30,
				 0,
				 100,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Size of the clan name in name plates")
MACRO_CONFIG_INT(
	ClNamePlatesIds, cl_nameplates_ids, 0, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Show client IDs in name plates")
MACRO_CONFIG_INT(ClNamePlatesIdsSize,
				 cl_nameplates_ids_size,
				 50,
				 0,
				 100,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Size of the client IDs in name plates")
MACRO_CONFIG_INT(ClNamePlatesFriendMark,
				 cl_nameplates_friendmark,
				 0,
				 0,
				 1,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Show friend mark (heart) in name plates")
MACRO_CONFIG_INT(ClNamePlatesOwn,
				 cl_nameplates_own,
				 0,
				 0,
				 1,
...
// ===== Smooth Spectating =====
MACRO_CONFIG_INT(ClSmoothSpectatingTime,
				 cl_smooth_spectating_time,
				 300,
				 0,
				 5000,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Time of smooth camera switch animation when spectating in ms (0 for off)")
...
MACRO_CONFIG_INT(ClDyncamStabilizing,
				 cl_dyncam_stabilizing,
				 0,
				 0,
				 100,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Amount of camera slowdown during fast cursor movement")

// ===== Smooth Spectating =====
MACRO_CONFIG_INT(EdAutosaveInterval,
				 ed_autosave_interval,
				 10,
				 0,
				 240,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Interval in minutes at which the editor map is auto-saved (0 for off)")
MACRO_CONFIG_INT(EdAutosaveMax,
				 ed_autosave_max,
				 10,
				 0,
				 1000,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Maximum number of autosaves per map (0 = no limit)")

// ===== Desktop Notifications =====
MACRO_CONFIG_INT(ClShowNotifications,
...
// ===== Streamer Mode =====
MACRO_CONFIG_INT(ClStreamerMode,
				 cl_streamer_mode,
				 0,
				 0,
				 1,
				 CFGFLAG_SAVE | CFGFLAG_CLIENT,
				 "Censor sensitive information such as passwords")
#endif
