...
#define PRINTF_FORMAT_ATTRIBUTE(FormatIndex, FirstArgument)                                                            \
	__attribute__((format(gnu_printf, FormatIndex, FirstArgument)))
...
#define mem_check() dbg_assert_imp(__FILE__, __LINE__, mem_check_imp(), "Memory check failed")
	...
	*/
	...
	/* Flushes userspace buffers and synchronizes the file to stable storage. */
...
typedef long long int64;
	...
	*/
	...
	/*
		...
		Parameters:
			...
			addr - Pointer to an address that will be filled in the remote address (optional, can be 0).
	...
	*/
	...
	/*
		...
		Returns:
			...
			Returns 0 of needle could not be found.
	...
	*/
	...
	/* Returns 1 only for a regular file, without following symbolic links. */
