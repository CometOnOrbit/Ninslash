...
CAIbunny2::CAIbunny2(CGameContext *pGameServer, CPlayer *pPlayer) : CAI(pGameServer, pPlayer)
{
	m_SkipMoveUpdate = 0;
...
void CAIbunny2::OnCharacterSpawn(CCharacter *pChr)
{
...
void CAIbunny2::ReceiveDamage(int CID, int Dmg)
{
	// m_ShockTimer = 10;
	// m_Attack = 0;
}
