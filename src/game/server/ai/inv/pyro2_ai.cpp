...
CAIpyro2::CAIpyro2(CGameContext *pGameServer, CPlayer *pPlayer) : CAI(pGameServer, pPlayer)
{
	m_SkipMoveUpdate = 0;
...
void CAIpyro2::OnCharacterSpawn(CCharacter *pChr)
{
...
void CAIpyro2::ReceiveDamage(int CID, int Dmg)
{
	// m_ShockTimer = 10;
	// m_Attack = 0;
}
