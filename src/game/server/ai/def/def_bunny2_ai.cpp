...
CAIdefbunny2::CAIdefbunny2(CGameContext *pGameServer, CPlayer *pPlayer)
...
void CAIdefbunny2::OnCharacterSpawn(CCharacter *pChr)
{
...
void CAIdefbunny2::ReceiveDamage(int CID, int Dmg)
{
	//m_ShockTimer = 10;
	//m_Attack = 0;
}
