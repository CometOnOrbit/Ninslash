...
#include "def_robot2_ai.h"

CAIdefrobot2::CAIdefrobot2(CGameContext *pGameServer, CCharacter *pCharacter) : CAI(pGameServer, pCharacter)
{
	m_SkipMoveUpdate = 0;
...
void CAIdefrobot2::OnCharacterSpawn(CCharacter *pChr)
{
...
void CAIdefrobot2::ReceiveDamage(int CID, int Dmg)
{
	// m_ShockTimer = 10;
	m_Attack = 0;
}

void CAIdefrobot2::DoBehavior()
{
	m_Attack = 0;
