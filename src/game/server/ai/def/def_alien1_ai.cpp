...
#include "def_alien1_ai.h"

CAIdefalien1::CAIdefalien1(CGameContext *pGameServer, CCharacter *pCharacter) : CAI(pGameServer, pCharacter)
{
	m_SkipMoveUpdate = 0;
...
void CAIdefalien1::OnCharacterSpawn(CCharacter *pChr)
{
...
void CAIdefalien1::ReceiveDamage(int CID, int Dmg)
{
	// m_ShockTimer = 10;
	m_Attack = 0;
}

void CAIdefalien1::DoBehavior()
{
	m_Attack = 0;
