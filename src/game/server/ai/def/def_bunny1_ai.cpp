...
#include "def_bunny1_ai.h"

CAIdefbunny1::CAIdefbunny1(CGameContext *pGameServer, CCharacter *pCharacter) : CAI(pGameServer, pCharacter)
{
	m_SkipMoveUpdate = 0;
	Player()->SetCustomSkin(6);
	m_StartPos = vec2(0, 0);
	m_ShockTimer = 0;
}

void CAIdefbunny1::OnCharacterSpawn(CCharacter *pChr)
{
...
void CAIdefbunny1::ReceiveDamage(int CID, int Dmg)
{
	// m_ShockTimer = 10;
	m_Attack = 0;
}

void CAIdefbunny1::DoBehavior()
{
	m_Attack = 0;
