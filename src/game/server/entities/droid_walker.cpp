...
CWalker::CWalker(CGameWorld *pGameWorld, vec2 Pos) : CDroid(pGameWorld, Pos, DROIDTYPE_WALKER)
{
...
void CWalker::TakeDamage(vec2 Force, int Dmg, const CAttackSource &Source, vec2 Pos)
{
