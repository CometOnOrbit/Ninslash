...
MACRO_CONFIG_INT(UiColorSat, ui_color_sat, 16, 0, 255, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Interface color saturation")
MACRO_CONFIG_INT(UiColorLht, ui_color_lht, 188, 0, 255, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Interface color lightness")
MACRO_CONFIG_INT(UiColorAlpha, ui_color_alpha, 222, 0, 255, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Interface alpha")
MACRO_CONFIG_INT(UiColorHue2, ui_color_hue2, 150, 0, 255, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Secondary interface color hue")
MACRO_CONFIG_INT(UiColorSat2, ui_color_sat2, 10, 0, 255, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Secondary interface color saturation")
MACRO_CONFIG_INT(UiColorLht2, ui_color_lht2, 128, 0, 255, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Secondary interface color lightness")
MACRO_CONFIG_INT(UiColorAlpha2, ui_color_alpha2, 190, 0, 255, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Secondary interface alpha")
