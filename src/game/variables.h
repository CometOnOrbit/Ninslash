...
MACRO_CONFIG_INT(ClNameplates, cl_nameplates, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Show name plates")
MACRO_CONFIG_INT(ClNameplatesAlways, cl_nameplates_always, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Always show name plates disregarding of distance")
MACRO_CONFIG_INT(ClNameplatesTeamcolors, cl_nameplates_teamcolors, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Use team colors for name plates")
MACRO_CONFIG_INT(ClNameplatesSize, cl_nameplates_size, 40, 0, 100, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Size of the name plates from 0 to 100%")
MACRO_CONFIG_INT(ClAutoswitchWeapons, cl_autoswitch_weapons, 0, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Auto switch weapon on pickup")
...
MACRO_CONFIG_INT(ClHitFeedback, cl_hit_feedback, 70, 0, 100, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Hit feedback strength")
MACRO_CONFIG_INT(ClMovementFeedback, cl_movement_feedback, 60, 0, 100, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Movement feedback strength")
...
MACRO_CONFIG_INT(ClTutorialState, cl_tutorial_state, 0, 0, 3, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "New player tutorial state")
MACRO_CONFIG_INT(ClTutorialCheckpoint, cl_tutorial_checkpoint, 0, 0, 6, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "New player tutorial checkpoint")
MACRO_CONFIG_INT(ClTutorialActive, cl_tutorial_active, 0, 0, 1, CFGFLAG_CLIENT, "Show the local tutorial HUD")
MACRO_CONFIG_INT(ClTutorialVersion, cl_tutorial_version, 0, 0, 99, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Tutorial content version")
MACRO_CONFIG_INT(ClTutorialChapter, cl_tutorial_chapter, 1, 1, 6, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Tutorial chapter to resume")
MACRO_CONFIG_INT(ClTutorialStep, cl_tutorial_step, 0, 0, 9, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Tutorial step to resume")
MACRO_CONFIG_INT(ClTutorialCompletedMask, cl_tutorial_completed_mask, 0, 0, 63, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Completed tutorial chapters")
MACRO_CONFIG_INT(ClTutorialPromptHandled, cl_tutorial_prompt_handled, 0, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Initial tutorial prompt has been handled")
...
MACRO_CONFIG_STR(ClLanguagefile, cl_languagefile, 255, "", CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "What language file to use")
MACRO_CONFIG_INT(ClLanguagecode, cl_languagecode, 0, 0, 999, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Language code sent to the server")

MACRO_CONFIG_INT(PlayerColorBody, player_color_body, 0, 0, 0xFFFFFF, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Player body color")
MACRO_CONFIG_INT(PlayerColorFeet, player_color_feet, 0, 0, 0xFFFFFF, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Player feet color")
MACRO_CONFIG_INT(PlayerColorTopper, player_color_topper, 65535, 0, 0xFFFFFF, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Player topper color")
MACRO_CONFIG_INT(PlayerColorSkin, player_color_skin, 65535, 0, 0xFFFFFF, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Player skin color")
MACRO_CONFIG_STR(PlayerTopper, player_topper, 24, "default", CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Player hair or hat")
...
MACRO_CONFIG_INT(UiColorHue, ui_color_hue, 150, 0, 255, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Interface color hue")
MACRO_CONFIG_INT(UiColorSat, ui_color_sat, 16, 0, 255, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Interface color saturation")
MACRO_CONFIG_INT(UiColorLht, ui_color_lht, 188, 0, 255, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Interface color lightness")
MACRO_CONFIG_INT(UiColorAlpha, ui_color_alpha, 222, 0, 255, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Interface alpha")
MACRO_CONFIG_INT(UiColorHue2, ui_color_hue2, 150, 0, 255, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Secondary interface color hue")
MACRO_CONFIG_INT(UiColorSat2, ui_color_sat2, 10, 0, 255, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Secondary interface color saturation")
MACRO_CONFIG_INT(UiColorLht2, ui_color_lht2, 128, 0, 255, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Secondary interface color lightness")
MACRO_CONFIG_INT(UiColorAlpha2, ui_color_alpha2, 190, 0, 255, CFGFLAG_CLIENT|CFGFLAG_SAVE|CFGFLAG_CLOUD, "Secondary interface alpha")
...
MACRO_CONFIG_INT(SvRegisterSteam, sv_register_steam, 1, 0, 1, CFGFLAG_SERVER, "Advertise this UDP server in the Steam GameServer list when Steamworks is available")
MACRO_CONFIG_STR(SvModHash, sv_mod_hash, 65, "", CFGFLAG_SERVER, "Required Workshop mod collection hash; empty disables mods")
MACRO_CONFIG_STR(SvModIds, sv_mod_ids, 1024, "", CFGFLAG_SERVER, "Comma-separated root Workshop PublishedFileIDs")
MACRO_CONFIG_STR(SvModWhitelist, sv_mod_whitelist, 1024, "", CFGFLAG_SERVER, "Comma-separated Workshop PublishedFileIDs allowed by this server; empty allows all")
...
MACRO_CONFIG_INT(SvSurvivalMode, sv_survivalmode, 0, 0, 2, CFGFLAG_SERVER, "Survival mode (0=free respawn, 1+=no auto-respawn; coop: revive via Respawn device / next floor, wipe when all dead)")
...
MACRO_CONFIG_INT(ClZoom, cl_zoom, 10, 0, 30, CFGFLAG_SAVE|CFGFLAG_CLIENT|CFGFLAG_CLOUD, "Camera zoom level (10 = default, lower = more zoomed in)")
#endif
