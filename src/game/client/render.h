...
public:
	...
	void RenderWeapon(const CWeaponSpec &Weapon, vec2 Pos, vec2 Dir, float Size, bool BeginQuads = false, int Flags = 0, float Alpha2 = 1.0f, bool KillMessage = false, bool NoFlags = false, bool Turret = false, float OverallAlpha = 1.0f);
