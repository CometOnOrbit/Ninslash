...
void CCBelt::RenderCBelt(int i)
{
	...
	// the belt part
	{
		Graphics()->QuadsSetSubsetFree(tx1 * Dir, 0.0f, tx2 * Dir, 0.0f, tx1 * Dir, 0.5f, tx2 * Dir, 0.5f);

		IGraphics::CFreeformItem Freeform(
			Pos.x, Pos.y, Pos.x + Width, Pos.y, Pos.x, Pos.y + 32, Pos.x + Width, Pos.y + 32);
	...
	// left corner
	{
		Graphics()->QuadsSetSubsetFree(0.0f, 0.5f, 1 / 4.0f, 0.5f, 0.0f, 1.0f, 1 / 4.0f, 1.0f);

		IGraphics::CFreeformItem Freeform(
			Pos.x - 1, Pos.y, Pos.x - 1 + 32, Pos.y, Pos.x - 1, Pos.y + 32, Pos.x - 1 + 32, Pos.y + 32);
	...
	// right corner
	{
		...
		IGraphics::CFreeformItem Freeform(Pos.x + 1 + Width,
										  Pos.y,
										  Pos.x + 1 + Width - 32,
										  Pos.y,
										  Pos.x + 1 + Width,
