...
class CItems : public CComponent
{
	...
	void RenderFlag(const CNetObj_Flag *pPrev,
	...
	void RenderScriptEntity(const struct CNetObj_ScriptEntity *pCurrent, int ItemID);
	void RenderPredictedScriptEntities();
